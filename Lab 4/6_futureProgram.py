#   FuturePE6.py
#   File name: 6_FutureProgram
#   A program that modifys an existing graphical future value program
#   by: Matthew Wilde
#   10/01/2020
...
def main():
    ...
    textEntry.draw(win1)
    text1 = Text(Point(200,200), 'Click mouse anywhere in white to continue')
    text1.draw(win1)
